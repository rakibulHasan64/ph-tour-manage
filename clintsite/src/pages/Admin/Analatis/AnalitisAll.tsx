...
const StatCard: React.FC<{
   ...
   <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg flex items-center gap-4 border border-gray-200 dark:border-gray-700 hover:shadow-xl transition">
      <div
...
const AnalitisAll: React.FC = () => {
   ...
   return (
      <div className="p-6 md:p-10 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-950 min-h-screen">
         <h1 className="text-4xl font-extrabold mb-12 text-center bg-gradient-to-r from-indigo-500 to-purple-600 bg-clip-text text-transparent">
         ...
         <section className="mb-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-10">
               <StatCard title="Total Users" value={userStats.totalUser} icon={<User />} iconColor="text-purple-500" />
               <StatCard title="Active Users" value={userStats.totalActive} icon={<CheckCircle />} iconColor="text-green-500" />
               <StatCard title="Blocked Users" value={userStats.totalBlocked} icon={<Lock />} iconColor="text-red-500" />
               <StatCard title="New Users (7d)" value={userStats.newUserInLast7Days} icon={<User />} iconColor="text-blue-500" />
               <StatCard title="New Users (30d)" value={userStats.newUserInLast30Days} icon={<User />} iconColor="text-indigo-500" />
            </div>
            ...
            <div className="">
               {tourStats && (
                  <section className="mb-16">
                     ...
                     <div className="">
                        <StatCard title="Total Tours" value={tourStats.totalTour} icon={<Map />} iconColor="text-teal-500" />
                     </div>
                  </section>
               )}
            </div>
            ...
            <div className="">
               {bookingStats && (
                  <section className="mb-16">
                     ...
                     <div className="">
                        <StatCard title="Total Bookings" value={bookingStats.totalBooking} icon={<CheckCircle />} iconColor="text-orange-500" />
                     </div>
                  </section>
               )}
            ...
            <div className="">
               {paymentStats && (
                  <section>
                     ...
                     <div className="">
                        <StatCard title="Total Payments" value={paymentStats.totalPaymant} icon={<CreditCard />} iconColor="text-pink-500" />
                     </div>
                  </section>
               )}
            </div>
