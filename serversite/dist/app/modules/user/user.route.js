...
router.get("/all-user", (0, chakAuth_1.checkAuth)(user_interface_1.Role.ADMIN, user_interface_1.Role.SUPER_ADMIN), user_contolers_1.userControllers.getMeAllUsers);
router.get("/me", (0, chakAuth_1.checkAuth)(...Object.values(user_interface_1.Role)), user_contolers_1.userControllers.getAllUsers);
