...
router.post("/init-payment/:bookingId", pymatContoler_1.PymantCallation.initPyment);
...
router.get("/invoice/:paymantId", (0, chakAuth_1.checkAuth)(...Object.values(user_interface_1.Role)), pymatContoler_1.PymantCallation.getInvoiceDownload);
