...
exports.createNewAccessTokenWithRefresToken = exports.creatUserTokens = void 0;
...
exports.creatUserTokens = creatUserTokens;
const createNewAccessTokenWithRefresToken = (refreshToken) => __awaiter(void 0, void 0, void 0, function* () {
    const verifiedRefreshToken = (0, jwt_1.verifyToken)(refreshToken, env_1.envVars.JWT_REFRESH_SECRET);
    const isUserExist = yield user_module_1.User.findOne({ email: verifiedRefreshToken.email });
    if (!isUserExist) {
...
exports.createNewAccessTokenWithRefresToken = createNewAccessTokenWithRefresToken;
